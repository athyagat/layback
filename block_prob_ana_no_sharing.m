...
avg_call_load_BETAtot     =   30;                %  Sum of all computing for a call (BETAtot)
...
title('Blocking Prob. w/o Sharing');

%% To save the file
block_prob_ana_sharing_var = [lambda_times_N;blocking_prob_O];
dlmwrite(fullfile(pwd, sprintf('plots_prateek\\block_prob_no_sharing_ana.txt')), block_prob_ana_sharing_var', '\t');